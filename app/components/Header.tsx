...
export function Header() {
    return (
        <header
            className="w-full py-4 flex justify-between bg-red-50 items-center">
            ...
            <div className="font-bold text-xl italic">VYBE</div>
            <div className="flex gap-2 items-center">
                <button
                    className="border-2 border-slate-300 rounded-full justify-center flex items-center p-2 h-10 w-10">
                    <MagnifyingGlassIcon className="w-4 h-4"/>
                </button>
                <div
                    className="border-2 border-slate-300 w-fit h-10 gap-0.5 rounded-full flex items-center pl-0.5 pr-2 py-0.5">
                    <Image
