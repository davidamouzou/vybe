...
export function Hero() {
    return (
        <section className="px-4 md:px-8 pt-4 overflow-hidden">
            ...
            <div
                className="bg-red-400 text-white flex flex-col md:flex-row justify-between md:px-10 px-0 pt-10 rounded-3xl h-1/3">
                ...
                <div
                    className="md:w-1/2 bg-red-400 rounded-2xl z-20 flex flex-row md:flex-col items-center justify-between md:justify-center p-4 md:p-0">
                    <div className="w-1/2 md:w-full flex flex-col md:items-center justify-between md:justify-center">
                        <div className="flex flex-col md:flex-row gap-6 text-sm">
                            {news.map((item, index) => (
                                <div key={index}
                                     className="flex align-middle flex-col justify-center items-center gap-2 mb-4 md:mb-0">
                                    {item.icon}
                                    <div>{item.title}</div>
                                </div>
                            ))}
                    ...
                    <div className="flex w-1/2 md:w-full flex-col  items-center">
                        ...
                        <div className="text-black bg-white p-1 rounded-3xl overflow-hidden">
                            ...
                            <button
                                className="mb-2 pr-4 p-0.5 gap-2 bg-red-400 text-white rounded-full flex items-center">
                                <div
                                    className="bg-white flex items-center justify-center text-red-400 rounded-full px-4 py-2">
